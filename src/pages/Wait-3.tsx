...
const ScoreEdit = () => {
  ...
  const { Subj, Credit } = location.state;

  const [rows, setRows] = useState([...Array(5)].map(() => ({
    Idtsu: '',
    Midterm: '',
    Final: '',
  })));
                  ...
                  <tr key={index} className="bg-gray-100">
                    ...
                    <th className="p-2">
                      <input
                        ...
                        value={rowData.Idtsu}
                        onChange={(e) => handleChangeRow(index, 'Idtsu', e.target.value)}
                        required
                      />
                    </th>
                    ...
                    <th className="border p-2">
                      <input
                        ...
                        value={rowData.Midterm}
                        onChange={(e) => handleChangeRow(index, 'Midterm', e.target.value)}
                        required
                      />
                    </th>
                    <th className="border p-2 bg-yellow-200">
                      <input
                        ...
                        placeholder="กรุณากรอกคะแนน"
                        value={rowData.Final}
                        onChange={(e) => handleChangeRow(index, 'Final', e.target.value)}
                        required
                      />
                    </th>
                    <th className="border p-2"></th>
